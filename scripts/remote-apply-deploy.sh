...
npx prisma generate
npx prisma db push
# 头像预设迁移：旧 .svg 预设 URL -> 新 .png（幂等，脚本内自带 dotenv 加载）
...
curl -sS -o /dev/null -w "avatar01_png=%{http_code}\n" http://127.0.0.1:3010/avatars/presets/avatar-01.png
curl -sS -o /dev/null -w "avatar16_png=%{http_code}\n" http://127.0.0.1:3010/avatars/presets/avatar-16.png
curl -sS -o /dev/null -w "avatar01_svg_should_be_404=%{http_code}\n" http://127.0.0.1:3010/avatars/presets/avatar-01.svg
