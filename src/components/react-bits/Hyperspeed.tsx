// @ts-nocheck — React Bits vendor; three/postprocessing may be incomplete in local node_modules.
...
class App {
  ...
  dispose() {
    ...
    if (this.renderer) {
      ...
      // Avoid forceContextLoss — remount races leave getContextAttributes() null
    }
