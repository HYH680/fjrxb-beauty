// @ts-nocheck — three types incomplete in local @types/three (same as Hyperspeed/FuturisticCanvas).
"use client";
...
export const GridScan = ({
  ...
  const pushScan = (t: number) => {
    ...
    if (materialRef.current) {
      ...
      (u.uScanStarts.value as number[]) = buf;
  ...
  useEffect(() => {
    ...
    // 用 window 级监听：背景层 pointer-events:none，页面内容覆盖其上时依然能驱动视差
